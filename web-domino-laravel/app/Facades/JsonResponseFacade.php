 ...
 * @method static dict($data = [], string $msg = '读取成功', ...$details): JsonResponse
 * @method static data($data = [], string $msg = '读取成功', ...$details): JsonResponse
 * @method static ok($msg = '操作成功'): JsonResponse
